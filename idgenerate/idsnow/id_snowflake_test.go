...
// func newSnowflake(t *testing.T, st Settings) *Snowflake {
// 	sf, err := New(st)
// 	if err != nil {
...
// func nextID(t *testing.T, sf *Snowflake) int64 {
// 	id, err := sf.NextID()
// 	if err != nil {
// 		t.Fatalf("failed to generate id: %v", err)
// 	}
...
// 	sf := newSnowflake(t, Settings{StartTime: time.Now()})
...
// 	sf1 := newSnowflake(t, Settings{MachineID: func() (int, error) { return 1, nil }})
// 	sf2 := newSnowflake(t, Settings{MachineID: func() (int, error) { return 2, nil }})
...
// func pseudoSleep(sf *Snowflake, period time.Duration) {
...
// 	start := time.Now()
// 	sf := newSnowflake(t, Settings{StartTime: start})
