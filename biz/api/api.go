...
func POST[In IRequest, Out any](ctx context.Context, req In, host, secret string) (*Out, error) {
...
func PUT[In IRequest, Out any](ctx context.Context, req In, host, secret string) (*Out, error) {
...
func GET[In IRequest, Out any](ctx context.Context, req In, host, secret string) (*Out, error) {
...
func DELETE[In IRequest, Out any](ctx context.Context, req In, host, secret string) (*Out, error) {
